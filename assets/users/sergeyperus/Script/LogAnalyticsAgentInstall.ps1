...
#In case rule already created if it is just update of port number it just updates rule
...
# Заменить на ID своей рабочей области
$OPSINSIGHTS_WS_ID = "8e511b5e-3741-43a8-9560-xxxxxxxxxxxxx"

# Заменить на свой ключ
$OPSINSIGHTS_WS_KEY = "Tq4SzNmtE3avPm9ntVfiwFKPOnpKkq9jBV6RKGfVehHpQSxxxxxxxxxxxxxxx"
...
$myoutfile1 = "$env:temp\MMASetup-AMD64.exe"
...
$arg2 = "/S"
$myoutfile2 = "$env:temp\InstallDependencyAgent-Windows.exe"
